                ...
                switch (tipo)
                {
                    ...
                    case "Actualización de Unidad":
                        ...
                        if (empresa == 1)
                        {
                            ...
                            unidad[4] = ("MODELO: " + (Convert.ToInt32(unidad[4]) == 1 ? "TRANSCARRIER" : "VOLVO"));
                            y1 = 120;
                            CrearAntesDespuesLabels();
                            mitad1mitad2(unidad);
                            y1 = null;
