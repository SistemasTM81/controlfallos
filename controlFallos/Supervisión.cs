...
namespace controlFallos
{
    ...
    public partial class Supervisión : Form
    {
        ...
        public Supervisión(int idUsuario, int empresa, int area)
        {
            InitializeComponent();
        ...
        {
            string sql = "SELECT CONCAT(insertar,';',consultar,';',editar,';',desactivar) as privilegios FROM privilegios where usuariofkcpersonal='" + idUsuario + "' and namform='Form1'";
