    ...
    public partial class requisicionRefacciones : Form
    {
        ...
        private void dtgRequicision_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (this.dtgRequicision.Columns[e.ColumnIndex].Name == "Estatus")
                e.CellStyle.BackColor = (e.Value.ToString() == "En Espera" ? System.Drawing.Color.Khaki : e.Value.ToString() == "Entregada" ? System.Drawing.Color.PaleGreen : System.Drawing.Color.LightBlue);
        }
        ...
        void exportar_excel()
        {
            ...
            */
            ...
            sl.SetCellStyle("B" + celdaCabecera, "L" + celdaCabecera, estiloCa);
            //Estilos de la tabla 
            ...
            sl.SetCellStyle("B" + celdaInicial, "L" + celdaCabecera, EstiloB);
