    ...
    public partial class nuevaRefaccion : Form
    {
        ...
        public void exporta_a_excel()
        {
            ...
            */
            ...
            int ic = 2;
            foreach (DataGridViewColumn column in tbrefaccion.Columns)
            {
            ...
            int ir = 9;
            foreach (DataGridViewRow row in tbrefaccion.Rows)
            {
            ...
            */
            ...
            sl.RenameWorksheet(SLDocument.DefaultFirstSheetName, "Consulta Nueva Refaccion");
            ...
            sl.SetCellStyle("B" + celdaCabecera, "AD" + celdaCabecera, estiloCa);
            //Estilos de la tabla 


            //Estilo Titulo

            sl.SetCellValue("D4", "CONSULTA NUEVAS REFACCIONES");
            ...
            sl.SetCellStyle("B" + celdaInicial, "AD" + celdaCabecera, EstiloB);

            //Ajustar celdas

            sl.AutoFitColumn("B", "AD");
            //Estilos Para bordes de la tabla
        ...
        void centradas(decimal costoUni, int moneda)
        {
            ...
            string idMaximo = v.getaData("select max(t1.idOrdCompra) from ordencompra as t1 inner join crequicision as t2 on t1.requicisionfkCRequicision = t2.idcrequicision inner join crefacciones as t3 on t3.idrefaccion = t2.refaccionfkCRefacciones where t3.codrefaccion ='" + txtcodrefaccion.Text + "' and t3.empresa = '" + empresa + "' and (t1.Estatus = 0 or t1.Estatus = 4)").ToString();
