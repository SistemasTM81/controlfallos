...
namespace controlFallos
{
    public class conexion
    {
        ...
        public string[] fieldsreporteUEx = new string[] { "idRUEX", " folioR", "empresaU", "unidad", " fechaHI", "envioReporte", "personaIngreso", "km", "fallosRepor", "mecanicoD", "inicioDiag", "mecanicoR", " diagnosticoMeca", "estatusDiag", " tipoRepa", " estatusRepa", " reafacciones", " folioFact", " reparacionesRa", " terminoDiag", " totalDiag", " espetaMante", " totMante", "mecaApoyo1","mecaApoyo2"};
    }
}