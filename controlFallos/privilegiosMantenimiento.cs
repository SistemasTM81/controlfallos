...
namespace controlFallos
{
    public partial class privilegiosMantenimiento : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            respaldo[3, 1] = v.Checked(btninsertartipo.BackgroundImage).ToString();
            respaldo[3, 2] = v.Checked(btnconsultartipo.BackgroundImage).ToString();
            respaldo[3, 3] = v.Checked(btnmodificartipo.BackgroundImage).ToString();
            respaldo[3, 4] = v.Checked(btneliminartipo.BackgroundImage).ToString();
            ...
            respaldo[4, 1] = v.Checked(btninsertarunidad.BackgroundImage).ToString();
            respaldo[4, 2] = v.Checked(btnconsultarunidad.BackgroundImage).ToString();
            respaldo[4, 3] = v.Checked(btnmodificarunidad.BackgroundImage).ToString();
            respaldo[4, 4] = "0";
            ...
            respaldo[5, 1] = v.Checked(btninsertarmante.BackgroundImage).ToString();
            respaldo[5, 2] = v.Checked(btnconsultarmante.BackgroundImage).ToString();
            respaldo[5, 3] = v.Checked(btnmodificarmante.BackgroundImage).ToString();
            respaldo[5, 4] = "0";
            respaldo[6, 0] = v.getIntFrombool((v.ImageToString(btnconsultarhistorial.BackgroundImage) == v.check)).ToString();
            respaldo[6, 1] = "0";
            respaldo[6, 2] = v.Checked(btnconsultarhistorial.BackgroundImage).ToString();
            respaldo[6, 3] = "0";
            respaldo[6, 4] = "0";
            catPersonal cat = (catPersonal)Owner;
            if (editar)
