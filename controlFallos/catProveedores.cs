...
namespace controlFallos
{
    public partial class catProveedores : Form
    {
        ...
        public catProveedores(int idUsuario, System.Drawing.Image logo, int empresa, int area, validaciones v)
        {
            ...
            d.ForeColor = System.Drawing.Color.FromArgb(75, 44, 52);
            d.SelectionBackColor = System.Drawing.Color.Crimson;
            d.SelectionForeColor = System.Drawing.Color.White;
            d.Font = new System.Drawing.Font("Garamond", 14, FontStyle.Bold);
            d.WrapMode = DataGridViewTriState.True; d.BackColor = System.Drawing.Color.FromArgb(200, 200, 200);
        ...
        void ExportarExcel()
        {
           ...
           */
            ...
            */
            ...
            int ic = 2;
            foreach (DataGridViewColumn column in tbProveedores.Columns)
            {
            ...
            foreach (DataGridViewRow row in tbProveedores.Rows)
            {
                ...
                sl.SetCellValue(ir, 21, row.Cells[19].Value.ToString());
                sl.SetCellValue(ir, 22, row.Cells[20].Value.ToString());
                sl.SetCellValue(ir, 23, row.Cells[21].Value.ToString());
                sl.SetCellValue(ir, 24, row.Cells[22].Value.ToString());
                sl.SetCellValue(ir, 25, row.Cells[23].Value.ToString());
                sl.SetCellValue(ir, 26, row.Cells[24].Value.ToString());
                sl.SetCellValue(ir, 27, row.Cells[25].Value.ToString());
                sl.SetCellValue(ir, 28, row.Cells[26].Value.ToString());
                sl.SetCellValue(ir, 29, row.Cells[27].Value.ToString());
                sl.SetCellValue(ir, 30, row.Cells[28].Value.ToString());
                sl.SetCellValue(ir, 31, row.Cells[29].Value.ToString());
                sl.SetCellValue(ir, 32, row.Cells[30].Value.ToString());
                sl.SetCellValue(ir, 33, row.Cells[31].Value.ToString());
                sl.SetCellValue(ir, 34, row.Cells[32].Value.ToString());
                sl.SetCellValue(ir, 35, row.Cells[33].Value.ToString());
            ...
            */
            ...
            sl.RenameWorksheet(SLDocument.DefaultFirstSheetName, "Consulta Proveedores");
            ...
            sl.SetCellStyle("B" + celdaCabecera, "AJ" + celdaCabecera, estiloCa);
            //Estilos de la tabla 


            //Estilo Titulo

            sl.SetCellValue("D4", "CONSULTA DE PROVEEDORES");
            ...
            sl.SetCellStyle("B" + celdaInicial, "AJ" + celdaCabecera, EstiloB);
