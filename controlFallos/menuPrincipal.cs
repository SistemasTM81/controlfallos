        ...
        void sesion()
        {
            while (res)
            {
                if (this.InvokeRequired)
                {
                    ...
                    dbcon = new MySqlConnection("Server = 127.0.0.1; user=controlFallos; password = controlFallos; database = sistrefaccmant ;port=3306");
                    dbcon.Open();
...
>>>>>>> 289438355dcf9ce0a48126f327236d2313a9d884
        ...
        public void cambiarstatus(object i)
        {
            ...
            MySqlConnection localConnection = new MySqlConnection("Server = 127.0.0.1; user=controlFallos; password = controlFallos; database = sistrefaccmant ;port=3306");
