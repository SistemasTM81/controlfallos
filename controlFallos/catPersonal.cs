...
namespace controlFallos
{
    ...
    public void busqPuestos()
        ...
        {
            GroupBox box = sender as GroupBox;
            v.DrawGroupBox(box, e.Graphics, System.Drawing.Color.FromArgb(75, 44, 52), System.Drawing.Color.FromArgb(200, 200, 200), this);
        }
...
*/
            ...
            int ic = 2;
            foreach (DataGridViewColumn column in busqEmpleados.Columns)
            {
            ...
            */
            ...
            sl.RenameWorksheet(SLDocument.DefaultFirstSheetName, "Registro de Empleados");
            ...
            sl.SetCellValue("D4", "REGISTRO DE EMPLEADOS");
